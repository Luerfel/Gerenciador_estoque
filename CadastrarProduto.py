...
def calcular_percentuais(entry_rendimento_mensal, entry_custo_fixo, entry_custo_mercadoria, entry_custo_operacional,
    ...
    calcular_porcentagem_custo(entry_rendimento_mensal, entry_custo_fixo, entry_percentual_custo_fixo,
                               "rendimento mensal")
    calcular_porcentagem_custo(entry_custo_mercadoria, entry_custo_operacional, entry_percentual_custo_operacional,
...
def tela_calculo_venda():
    ...
    btn_calcular = ttk.Button(frame, text="Calcular Percentuais",
                              command=lambda: calcular_percentuais(entry_rendimento_mensal, entry_custo_fixo,
    ...
    margem_lucro.trace("w", lambda name, index, mode, sv=margem_lucro: mostrar_lucro(sv))
    ...
    btn_calcular = ttk.Button(frame, text="Calcular preço de venda",
                              command=lambda: calcular_preco_venda(entry_custo_produto, entry_custo_imposto,
                                                                   entry_percentual_custo_fixo,
                                                                   entry_percentual_custo_operacional,
    ...
    btn_salvar = ttk.Button(frame, text="Salvar",
                            command=lambda: salvar_preco_venda(entry_preco_venda.get(), label_preco_venda_principal))
...
def mostrar_lucro(margem_lucro):
...
combo_fornecedor['values'] = (
"Fornecedor 1", "Fornecedor 2", "Fornecedor 3")  # Aqui você pode adicionar os fornecedores cadastrados
