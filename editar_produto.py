...
class EditarProduto():
    ...
    def editar_produto_design(self):
        # Método para configurar a interface de edição do produto
        ...
        # Botão para acessar a calculadora de preço de venda
        ...
        # Carrega os dados do produto selecionado nos campos de entrada
    ...
    def editar_design(self):
        # Método para configurar a interface principal de seleção de produtos
